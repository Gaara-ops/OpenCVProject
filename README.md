...
&nbsp&nbsp&nbsp&nbsp&nbsp有了DirectX射线跟踪和现代gpu，射射线比以往任何时候都要**快**。然而，光线跟踪并不是**免费的**。至少在不久的将来，您可以假设每个像素最多有几束光线。这意味着混合光线光栅算法、抗混叠、去噪和重建都是快速实现高质量渲染的关键。本书中的其他工作提供了一些关于这些主题的想法，但是许多问题仍然没有得到解决。
